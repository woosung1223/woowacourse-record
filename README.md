...
- [하루스터디 Website](https://haru-study.com)
- [하루스터디 Repository](https://github.com/woowacourse-teams/2023-haru-study)

<br>

### 포스팅 📝
- [영속성 컨텍스트 기본 개념 알아보기](https://dev-ws.tistory.com/76)
- [Java 11 vs. Java 17](https://haru-study.github.io/backend/Java-%EB%B2%84%EC%A0%84-%EC%84%A0%ED%83%9D-%EC%9D%B4%EC%9C%A0/)
- [Pull Request와 Merge Branch(feat. CI)](https://haru-study.github.io/github,%20backend/Pull-Request%EC%99%80-merge-branch(feat.-CI)/)
- [캐싱으로 인해 베포한 내용이 반영되지 않는 문제 해결하기](https://haru-study.github.io/cloudflare,%20backend/%EC%BA%90%EC%8B%B1%EC%9C%BC%EB%A1%9C-%EC%9D%B8%ED%95%B4-%EB%B0%B0%ED%8F%AC%ED%95%9C-%EB%82%B4%EC%9A%A9%EC%9D%B4-%EB%B0%98%EC%98%81%EB%90%98%EC%A7%80-%EC%95%8A%EB%8A%94-%EB%AC%B8%EC%A0%9C-%ED%95%B4%EA%B2%B0%ED%95%98%EA%B8%B0/)
- [브라우저 저장소 개념 알아보기](https://dev-ws.tistory.com/80)
- [세션 방식의 인증과 토큰 방식의 인증 알아보기](https://dev-ws.tistory.com/81)
- [하루스터디 데이터베이스 설계 과정 및 느낀 점](https://dev-ws.tistory.com/83)
- [JWT 개념 이해해보기](https://dev-ws.tistory.com/87)
- [대칭키 vs. 비대칭키](https://dev-ws.tistory.com/89)
- [Oauth의 등장 배경 및 개념 이해해보기](https://dev-ws.tistory.com/91)
- [SOP와 CORS](https://dev-ws.tistory.com/92)

<br> 

### 회고 🤔
- [하루스터디 협업 1주차 회고](https://dev-ws.tistory.com/79)
- [하루스터디 협업 2주차 회고](https://dev-ws.tistory.com/82)
- [하루스터디 협업 3주차 회고](https://dev-ws.tistory.com/84)
- [하루스터디 협업 4주차 회고](https://dev-ws.tistory.com/85)
- [하루스터디 협업 5주차 회고](https://dev-ws.tistory.com/86)
- [하루스터디 협업 6주차 회고](https://dev-ws.tistory.com/88)
- [하루스터디 협업 7주차 회고](https://dev-ws.tistory.com/90)
- [우아한테크코스 레벨 3 회고](https://dev-ws.tistory.com/97)

## Level 4: 기반 기술에 대한 이해와 프로젝트 고도화
### 기간
...
|:-----:|:-----:|:-----:|:-----:|:-----:|:-----:|
|Tomcat 구현하기 <br>|[Repository](https://github.com/woowacourse/jwp-dashboard-http/tree/woosung1223)|[1단계 PR](https://github.com/woowacourse/jwp-dashboard-http/pull/304)|[2단계 PR](https://github.com/woowacourse/jwp-dashboard-http/pull/410) | X | X
| MVC 구현하기 <br>|[Repository](https://github.com/woowacourse/jwp-dashboard-mvc/tree/woosung1223)|[1단계 PR](https://github.com/woowacourse/jwp-dashboard-mvc/pull/360)|[2단계 PR](https://github.com/woowacourse/jwp-dashboard-mvc/pull/447) | [3단계 PR](https://github.com/woowacourse/jwp-dashboard-mvc/pull/561) | X
| JDBC 라이브러리 구현하기 <br>|[Repository](https://github.com/woowacourse/jwp-dashboard-jdbc/tree/woosung1223)|[1단계 PR](https://github.com/woowacourse/jwp-dashboard-jdbc/pull/304)|[2단계 PR](https://github.com/woowacourse/jwp-dashboard-jdbc/pull/382) | [3단계 PR](https://github.com/woowacourse/jwp-dashboard-jdbc/pull/437) | [4단계 PR](https://github.com/woowacourse/jwp-dashboard-jdbc/pull/517)
|레거시 코드 리팩토링 <br>|[Repository](https://github.com/woowacourse/jwp-refactoring/tree/woosung1223)|[1단계 PR](https://github.com/woowacourse/jwp-refactoring/pull/457)| [2단계 PR](https://github.com/woowacourse/jwp-refactoring/pull/548) | [3단계 PR](https://github.com/woowacourse/jwp-refactoring/pull/577) | [4단계 PR](https://github.com/woowacourse/jwp-refactoring/pull/739) 

<br> 

### 포스팅 📝
- [에러코드, 상태코드, 예외 메세지를 쉽게 관리해보자!(+에러코드 문서화)](https://dev-ws.tistory.com/93)
- [IO Stream이란 무엇일까?(+Stream이란?)](https://dev-ws.tistory.com/94)
- [HTTP 요청 및 응답 구조 알아보기](https://dev-ws.tistory.com/95)
- [maxThreads, maxConnections, acceptCount로 톰캣 튜닝하기](https://dev-ws.tistory.com/96)
- [리플렉션이란?(+@GetMapping 만들어보기)](https://dev-ws.tistory.com/98)
- [Servlet Filter란?](https://dev-ws.tistory.com/99)
- [DDL과 트랜잭션, 그리고 Atomic DDL](https://dev-ws.tistory.com/101)
- [어드민 페이지 개발하기 - 요구사항 분석](https://dev-ws.tistory.com/103)
- [어드민 페이지 개발하기 - 로그인 구현](https://dev-ws.tistory.com/104)
- [어드민 페이지 개발하기 - 통계 기능 구현](https://dev-ws.tistory.com/105)
- [DataSource 별 성능 테스트하기 & HikariCP는 왜 성능이 좋을까?](https://dev-ws.tistory.com/106)
- [쉽게 이해해보는 DispatcherServlet](https://dev-ws.tistory.com/108)
- [물리 트랜잭션과 논리 트랜잭션, 그리고 트랜잭션 전파에 관하여](https://dev-ws.tistory.com/109)
- [데이터베이스 호환성을 고려한 무중단 배포 진행하기](https://dev-ws.tistory.com/110)

<br>

### 회고 🤔
- [하루스터디 사용자 유치 기록 - 1](https://dev-ws.tistory.com/102)
- [레거시 리팩토링 미션 회고](https://dev-ws.tistory.com/111)

## 테코톡: 크루들에게 지식을 공유하는 자리
